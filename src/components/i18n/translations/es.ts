const es = {
  hero: {
    ...
    description: "Apasionado por crear experiencias web innovadoras y funcionales",
    contact: "CONTACTAR",
  },
  about: {
    title: "SOBRE MÍ",
    description:
      "Soy un desarrollador web con experiencia en tecnologías frontend y backend. Me especializo en crear aplicaciones web modernas y responsivas utilizando las últimas tecnologías.",
    student:
      "Estudiante de INGENIERÍA DE SOFTWARE en quinto semestre. Comprometido, proactivo y apasionado por el APRENDIZAJE CONTINUO.",
  },
  experience: {
    title: "EXPERIENCIA",
  ...
  testimonials: {
    ...
    client1: {
      ...
      text: "Juan Pablo demostró un excelente dominio técnico y una gran capacidad para resolver problemas complejos.",
    },
    client2: {
      name: "Carlos Rodríguez",
      role: "Director de Proyectos",
      text: "Su compromiso y profesionalismo hicieron que el proyecto fuera un éxito rotundo.",
    },
    client3: {
      name: "Laura Martínez",
      role: "Diseñadora UX",
      text: "Trabajar con Juan Pablo fue una experiencia muy enriquecedora. Su atención al detalle es impresionante.",
    },
    professor: {
    ...
    client_roberto: {
      ...
      text:
        "Juan Pablo desarrolló mi sitio web de comercio electrónico con gran profesionalismo. Entendió perfectamente mis necesidades y entregó un producto que superó mis expectativas. Su comunicación fue clara y constante durante todo el proceso.",
    },
  ...
  footer: {
    copyright: "© 2025 Juan Pablo Lucero Morales. Todos los derechos reservados.",
  },
  cv: {
