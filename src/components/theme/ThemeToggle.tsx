...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative inline-flex items-center justify-center p-1 w-12 h-6 rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 transition-colors duration-300"
